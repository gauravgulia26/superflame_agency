# Balaji Gas — Official Super Gas Authorized Dealer Website

A modern, mobile-first, production-ready business website for **Balaji Gas (Proprietor: Neeraj Dabas)**, an authorized **Super Gas Dealer** located at **Plot number 251/154, Kanhaiya Dharam Kata, Pooth Khurd, Delhi 110039**.

## Business Identity & Verified Data
* **Business Name:** Balaji Gas
* **Proprietor:** Neeraj Dabas
* **Dealership:** Authorized Dealer: Super Gas
...
## Tech Stack
* React 18, TypeScript, Tailwind CSS, Framer Motion, Embla Carousel, Canvas Confetti, Vite.
