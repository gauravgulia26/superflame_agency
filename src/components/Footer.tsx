        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 pb-10 border-b border-white/15">
          ...
          <div className="lg:col-span-5 space-y-3.5">
            ...
            <p className="text-xs text-white/80 leading-relaxed max-w-sm">
              Official authorized Super Gas dealer dedicated to safe, dependable, and high-efficiency LPG gas distribution. Delivering 5kg to 33kg cylinders across Delhi NCR.
            </p>
